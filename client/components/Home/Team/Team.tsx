...
const Team = () => {
  ...
  <div className="text-center mb-16">
    ...
    <p className="text-gray-600 text-lg max-w-3xl mx-auto leading-relaxed">
      Meet the passionate individuals who drive our company forward with their
      expertise, creativity, and dedication to delivering exceptional results.
    </p>
  </div>
  ...
  <div className="grid gap-10 sm:grid-cols-1 md:grid-cols-2 justify-center max-w-4xl mx-auto">
    ...
    <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-gray-200 hover:-translate-y-2">
      ...
      <div className="relative z-10 text-center">
        ...
        <p className="text-gray-600 leading-relaxed mb-4">
          Visionary leader with 15+ years in tech. Passionate about innovation
          and building solutions that make a difference.
        </p>

        <div className="flex flex-wrap gap-2 justify-center">
          <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Leadership</span>
          <span className="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">Strategy</span>
          <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">Innovation</span>
        </div>
      </div>
    </div>
    ...
    <div className="group relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 border border-gray-100 hover:border-gray-200 hover:-translate-y-2">
      ...
      <div className="relative z-10 text-center">
        ...
        <div className="flex flex-wrap gap-2 justify-center">
          <span className="px-3 py-1 bg-green-100 text-green-700 rounded-full text-xs font-medium">Architecture</span>
          <span className="px-3 py-1 bg-teal-100 text-teal-700 rounded-full text-xs font-medium">DevOps</span>
          <span className="px-3 py-1 bg-blue-100 text-blue-700 rounded-full text-xs font-medium">Full Stack</span>
        </div>
      </div>
    </div>
  </div>
